...
//                   <img
//                     src={`https://eblogbend.degefagomora.com/userPhotos/${previousPhoto}`}
//                     alt="userPhoto"
//                   />
//                 </div>
//               </div>
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { data } = await axios.post(
        `${process.env.REACT_APP_API_URL}/api/user/editProfile`,
        formData,
        config
      );
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="profile-img-upld-wrapper">
              ...
              <div className="currentImage">
                ...
                <img
                  src={`${process.env.REACT_APP_API_URL}/userPhotos/${previousPhoto}`}
                  alt="userPhoto"
                />
              </div>
            </div>
